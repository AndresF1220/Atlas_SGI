...
const SIDEBAR_WIDTH_ICON = "3.5rem" // Increased size for icon-only sidebar
...
>(({ className, ...props }, ref) => {
  return (
    <Separator
      ...
      className={cn("mx-0 my-2 w-auto bg-sidebar-border", className)}
      {...props}
    />
  )
})
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-2 overflow-auto group-data-[collapsible=icon]:items-center group-data-[collapsible=icon]:overflow-visible",
        className
      )}
      {...props}
    />
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-3 rounded-md p-2 text-left text-sm outline-none ring-sidebar-ring transition-all hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-blue-100 data-[active=true]:font-semibold data-[active=true]:text-blue-800 data-[active=true]:border-l-[5px] data-[active=true]:border-blue-700 data-[active=true]:pl-[10px] data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:!p-2 [&>svg]:size-5 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
